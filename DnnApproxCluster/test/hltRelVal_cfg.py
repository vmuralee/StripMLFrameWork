# hltGetConfiguration /users/vmuralee/PREmenu/V11 --globaltag auto:phase1_2024_realistic --mc --unprescale --max-events 100 --input /store/relval/CMSSW_14_1_0/RelValSinglePiFlatPt0p7To10/GEN-SIM-RECO/140X_mcRun3_2024_realistic_v21_STD_Recycled_2024_noPU-v1/2580000/a65a9d3e-c48b-4316-9947-64c1906fc136.root --eras Run3_2024 --l1-emulator uGT --l1 L1Menu_Collisions2024_v1_3_0_xml
...
process.hltOutputPhysicsHIPhysicsRawPrime0 = cms.OutputModule( "PoolOutputModule",
    fileName = cms.untracked.string( "/eos/home-v/vmuralee/PREanalysis/clusterMLstudies/FilesForCurrentDir/outputSinglePionRelValRawPrime1.root" ),
    ...
    outputCommands = cms.untracked.vstring(
        ...
        'keep FEDRawDataCollection_rawDataC*_*_HLTX',
        'keep *_mix_*_*',
