...
static constexpr auto s_tag = "[TrackEfficiencyAnalyzer]";

TEST_CASE("Standard checks of TrackEfficiencyAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("TrackEfficiencyAnalyzer"
